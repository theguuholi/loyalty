defmodule LoyaltyWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LoyaltyWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = Loyalty.AccountsFixtures.user_fixture()
